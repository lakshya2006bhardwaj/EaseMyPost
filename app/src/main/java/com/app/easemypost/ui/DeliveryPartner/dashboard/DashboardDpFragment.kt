package com.app.easemypost.ui.DeliveryPartner.dashboard
...
import com.app.easemypost.databinding.FragmentDashboardDpBinding
...
class DashboardDpFragment : Fragment() {
    private lateinit var binding:FragmentDashboardDpBinding
      override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View{
          binding=FragmentDashboardDpBinding.inflate(inflater)
    ...
    private fun showPieChart() = binding.apply {
        ...
        typeAmountMap["Active"] = 30.0
        typeAmountMap["Idle"] = 20.0
        typeAmountMap["Under Maintenance"] = 20.0
